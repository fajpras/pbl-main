    ...
    <div class="row flex-nowrap ">
      ...
      <main class="col p-0 main-cons">
        ...
        <section class="riwayat-section">
          ...
          <?php 
          $Q_cekDok = mysqli_query($conn, "select * from dokumens where ids_warga = $id");
          ...
          <?php
          $query = "select *, date_format(tanggal, '%d %M %Y') as date, nama_dokumen, status, ids_warga, komentar from dokumens where ids_warga = $id";
          ...
          if(mysqli_num_rows($validasi) > 0){
            ...
            while ($row = mysqli_fetch_assoc($validasi)) {
              ...
              // Ambil Komentar/Alasan (pastikan kolom di database namanya 'komentar' atau sesuaikan)
              ...
              // Logika Tombol & Warna Status
              $tombol_aksi = ""; // Variabel penampung HTML tombol

              if ($get_status == 'PENDING' ){
                $status_label = "Menunggu Verifikasi";
                $warna = "bg-warning text-black";
                // Tidak ada tombol aksi jika pending
                ...
                // Kita simpan data di atribut 'data-'
