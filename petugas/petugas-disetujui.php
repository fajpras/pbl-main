...
<html lang="id">
  ...
  <head>
    ...
    <title>Petugas Disetujui | AJUK</title>
            ...
            <div class="pengajuan-section">
              <div class="content">
                <div class="content-overlay">
                  <h2 class="fw-medium mb-4 fw-bold text-start">Validasi Dokumen Pengajuan Warga</h2>
                  <div class="table-responsive">
                    <table class="table table-hover align-middle text-white">
                      ...
                      <tbody>
                        ...
                        <td>'.$dok_title.'</td>
                        <td>'.$row['date'].'</td>
                        <td width="" class="align-items-center"><div class="rounded-2 py-2 fs-7 px-1 bg-success">'.$row['status'].'</div></td>
                        <td>
